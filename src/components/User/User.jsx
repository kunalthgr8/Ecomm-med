          ...
          <>
            <div className="w-1/3 flex flex-row bg-nav-white h-[120px] rounded-lg p-4 gap-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-black-heading text-sm italic">
                  kunalsingla1126@gmail.com
                </p>
          ...
          <>
            <div className="w-1/3 flex flex-row bg-nav-white h-[120px] rounded-lg p-4 gap-2">
              ...
              <div className="flex flex-col gap-4 h-full w-full justify-center self-center ">
                ...
                <p className="text-black-heading text-sm italic font-serif cursor-pointer text-center" onClick={()=> navigate("/login")}>
                  Login Now
                </p>
              </div>
            </div>
